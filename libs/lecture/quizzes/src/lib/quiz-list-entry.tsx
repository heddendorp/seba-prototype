...
import {IQuizAnswer} from "@seba/models";
...
export function QuizListEntry(props: QuizListEntryProps) {
  ...
  return (
    <>
      <EditQuizDialog quiz={props.quiz} open={open} handleClose={handleEditQuiz}/>
                        ...
                        question.answers.map((answer: IQuizAnswer) => {
                          return (
                            ...
                            <FormControlLabel key={answer._id}
                              control={<Checkbox checked={answer.isCorrect} disabled={true}/>}
                              label={answer.answer}
                            />);
                        })
                      }
