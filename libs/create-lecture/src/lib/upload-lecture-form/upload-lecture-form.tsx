...
export interface UploadLectureFormProps {
  handleSubmit: (title: string, dateTime: string, description: string, file: File) => void;
}
  ...
  return (
    <form className={classes.formStyle} onSubmit={handleSubmit}>
      <Grid container spacing={2}>
        ...
        <Grid item xs={12}>
          <LinearProgress variant="determinate" className={classes.formProgressBar} value={progress}/>
        </Grid>
        <Grid item xs={12}>
          <Button autoFocus>
            Cancel
